...
export class Book extends React.Component<any, any>{
    ...
    render() {
        ...
        return (
            <div className={language === 'Hebrew' ? 'hebrewOpacity column' : 'normalOpacity column'} style={cardStyle}>
                <div className="card">
                    <h3>Title: {title}</h3>
                    ...
                    <p>Year: {year}</p>
                    <p>Country: {country}</p>
                    <p className={language === 'Hebrew' ? 'hebrewColor' : 'normalColor'}>Language: {language}</p>
